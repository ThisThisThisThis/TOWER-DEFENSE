...
def Clic(event):
    ...
    [xmin,ymin,xmax,ymax] = Canevas.bbox(tour1)
...
tour= PhotoImage(file="images/tour1.gif")
tour1=Canevas.create_image(50,50,anchor=NW,image=tour)
